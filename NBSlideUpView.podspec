#
#  Be sure to run `pod spec lint NBSlideUpView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of NBSlideUpView in Markdown format.
  ...
  # s.authors          = { "Neeraj Baid" => "wdaareg@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'Neeraj Baid', 'other author'
  ...
  s.source       = { :git => "https://github.com/neerajbaid/NBSlideUpView.git"}
